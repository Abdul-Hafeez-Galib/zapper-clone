...
app.get("/nativeBalance", async (req, res) => {
  ...
  try {
    ...
    if (chain === "0x1") {
      nativeCurrency = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"; // WETH Contract
    } else if (chain === "0x89") {
      nativeCurrency = "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270"; // WMATIC Contract
    }
